...
<?php echo wp_kses(implode(USWBG_print_lStylePath('public/dist/css/app_demo_3.4.10-cad6b5ba.css')), $allowedTags); ?>
...
<body class='body-defender'>
    ...
    <script src='<?php echo esc_attr(Variables::$A4B_PLUGIN_BASE_URL . 'assets/js/jszip.min-3.4.10-cad6b5ba.js'); ?>'></script>
<script src='<?php echo esc_attr(Variables::$A4B_PLUGIN_BASE_URL . 'assets/js/api-3.4.10-cad6b5ba.js'); ?>'></script>
<script src='<?php echo esc_attr(Variables::$A4B_PLUGIN_BASE_URL . 'public/dist/js/app_demo_3.4.10-cad6b5ba.js'); ?>'></script>
<script src='<?php echo esc_attr(Variables::$A4B_PLUGIN_BASE_URL . 'public/dist/js/chunk-vendors_demo_3.4.10-cad6b5ba.js'); ?>'></script>
</body>
